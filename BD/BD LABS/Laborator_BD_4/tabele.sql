...
CREATE TABLE COPIE_FARMACIE_DETALII(
	FarmacieId INT PRIMARY KEY IDENTITY(1,1),
	Nume NVARCHAR(50),
	Locatie NVARCHAR(100)
);
GO
CREATE TABLE COPIE_MEDICAMENTE(
	MedicamentId INT PRIMARY KEY IDENTITY(1,1),
	Nume VARCHAR(50),
	Descriere NVARCHAR (500),
	Pret FLOAT,
	Stoc INT,
	FarmacieId INT,
	FOREIGN KEY (FarmacieId) REFERENCES COPIE_FARMACIE_DETALII(FarmacieId)
);
GO

CREATE TABLE COPIE_FURNIZORI(
	FurnizoriId INT PRIMARY KEY IDENTITY(1,1),
	Nume NVARCHAR(50),
	Adresa NVARCHAR(100)
);
...
CREATE TABLE COPIE_FURNIZORI_MEDICAMENTE(
	FurnizoriId INT,
	MedicamentId INT,
	PRIMARY KEY (FurnizoriId, MedicamentId),
	FOREIGN KEY (FurnizoriId) REFERENCES COPIE_FURNIZORI(FurnizoriId),
	FOREIGN KEY (MedicamentId) REFERENCES COPIE_MEDICAMENTE(MedicamentId)
);
GO
